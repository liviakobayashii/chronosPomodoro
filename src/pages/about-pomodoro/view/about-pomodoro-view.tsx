...
export function AboutPomodoro() {
    ...
    return (
        <>          <Button onClick={() => navigate("/")} className="p-8">
            ...
            <Card className=" px-10 py-15 container flex flex-col justify-center gap-15 border-primary border-2 shadow-xl">

                <h2 className="text-center text-5xl font-bold">A Técnica Pomodoro 🍅</h2>
